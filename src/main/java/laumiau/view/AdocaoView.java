...
public class AdocaoView extends JFrame {
    ...
    private void criarTela() {
        ...
        card.add(caixaInfo("👤", nomeAdotante, COR_LARANJA, Color.WHITE));
        card.add(Box.createVerticalStrut(14));

        card.add(labelCampo("Status"));
        card.add(caixaInfo("●", "Disponível para adoção responsável", COR_VERDE, COR_VERDE_FUNDO));
    ...
    private JPanel caixaInfo(String icone, String texto, Color corIcone, Color fundo) {
