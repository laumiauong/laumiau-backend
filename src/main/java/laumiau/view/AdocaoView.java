...
public class AdocaoView extends JFrame {
    ...
    private void criarTela() {
        ...
        card.add(caixaInfo("🐱", nomeAnimal, COR_LARANJA, Color.WHITE));

        card.add(Box.createVerticalStrut(14));

        // ADOTANTE
        card.add(labelCampo("Adotante"));
        card.add(caixaInfoIcone(
                "/img/user-orange.png",
                nomeAdotante,
                COR_TEXTO,
                Color.WHITE
        ...
        checkTermo = new JCheckBox(
                "Li e confirmo que o termo foi assinado"
        );
        ...
        RoundedButton btnConfirmar =
                new RoundedButton("Confirmar adoção");
    ...
    private JLabel criarLogo() {
        ...
        java.net.URL url =
                getClass().getResource("/img/logo-lau-miau.png");
    ...
    private JPanel caixaInfo(
        ...
        lblTexto.setForeground(
                corIcone == COR_VERDE ? COR_VERDE : COR_TEXTO
        );
    ...
    private JPanel caixaInfoIcone(
        ...
        if (url != null) {
            ...
            lblIcone.setIcon(new ImageIcon(img));
        }
