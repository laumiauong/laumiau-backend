...
public class TutorView extends JFrame {
    ...
    static class AnimaisInteresseView extends JFrame {
        public AnimaisInteresseView() {
            ...
            JTextArea lista = new JTextArea("🐱 Gatinho - Disponível\n\n🐶 Rabinho - Em adoção\n\n🐱 Charmosa - Disponível");
    ...
    static class EditarPerfilTutorView extends JFrame {
        ...
        public EditarPerfilTutorView() {
            ...
            salvar.addActionListener(e -> JOptionPane.showMessageDialog(this, "Perfil atualizado com sucesso!", "Sucesso", JOptionPane.INFORMATION_MESSAGE));
            card.add(titulo);
            card.add(Box.createVerticalStrut(28));
            card.add(campoNome);
    ...
    static class RoundedButton extends JButton {
        RoundedButton(String text) {
            ...
            addMouseListener(new MouseAdapter() {
                @Override public void mouseEntered(MouseEvent e) { setBackground(COR_LARANJA_HV); repaint(); }
